...
SELECT
    a.EMP_NAME 사원명,b.JOB_NAME 직급명,a.SALARY 급여,a.EMP_ID,a.EMP_NO,a.EMAIL,a.PHONE,a.HIRE_DATE
FROM employee a
...
SELECT
    b.DEPT_TITLE 부서명, COUNT(a.DEPT_CODE) 인원, FORMAT(SUM(a.SALARY),0) 급여합계,FORMAT(AVG(a.SALARY),0) 급여평균
...
--    성이 전씨인 직원들의 사원명, 주민번호, 부서명, 직급명을 조회하시오.
    ...
    SELECT
           a.EMP_NAME 사원명,a.EMP_NO 주민번호,d.DEPT_TITLE 부서명,j.JOB_NAME
        FROM employee a
...
-- 8. 해외영업팀에 근무하는 사원명, 직급명, 부서코드, 부서명을 조회하시오.
    ...
    SELECT
            a.EMP_NAME,b.JOB_NAME,a.DEPT_CODE,d.DEPT_TITLE
        FROM employee a
        JOIN JOB b ON a.JOB_CODE = b.JOB_CODE
